...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0):
    ...
    img, target, idx = datasets.__getitem__(idx)
    #print(img, target, idx)
    
    img_data = datasets.get_img_info(idx)
    #print(img_data)
    ...
    for bbox,label in zip(bboxes,labels):
        ...
        print(label)
        x1,y1,x4,y4 = bbox
        draw.rectangle((int(x1),int(y1),int(x4),int(y4)),outline='black',width=5)
    img.show()
    exit()
    '''
    #==================================================
